...
from PyChemicals.titration_calculation import (
    Analyte, Titrant, volume_of_titrant,
    calculate_analyte_concentration, ph_at_equivalence,
...
def test_diprotic_titrations():
    ...
    v_eq2 = volume_of_titrant(acid, base, stoichiometric_ratio=0.5)  # Changed from 2.0 to 0.5
...
def test_buffer_regions():
    ...
    ph = ph_after_equivalence(weak_acid, strong_base, v_half)  # Pass actual volume added
